...
public class releasesProcessor implements PageProcessor {
  @Override
  ...
  public static void main(String[] args) {
    Spider.create(new releasesProcessor())
            .addUrl("https://api.github.com/repos/apolloconfig/apollo/releases?page=1&per_page=100")
